...
def ST_HEX_solver_Orjan(tubeside_flow_l_s, tubeside_temp_in_C, tubeside_temp_out,
                        ...
                        parts, tolerance, cross_or_counter_flow, nr_HEX_passes, nr_heat_exchangers,
    ...
    while (abs(shellside_temp_in_C - shellside_tempC_final) / shellside_temp_in_C > tolerance):
        ...
        if cross_or_counter_flow in ["counter_current", "counter", "countercurrent", "CounterCurrent"]:
...
class InputFrame(tk.Frame):
    ...
    def __create_widgets(self):
        ...
        create_widget_pair(column=2, row=18, text='Cross or Counter Flow:', var="cross_or_counter_flow")
...
class App(tk.Tk):
    def __init__(self):
        ...
        self.shared_data ={
            ...
            "cross_or_counter_flow": tk.StringVar(),
    ...
    def __set_default_values(self):
        ...
        self.shared_data["cross_or_counter_flow"].set("cross")
    ...
    def calculate(self):
            ...
            cross_or_counter_flow=self.shared_data['cross_or_counter_flow'].get()
            ...
            T_data.to_csv('heat_exchanger_results.csv', index=False)
    ...
    def plot_graph(self, data):
        ...
        # Plotting both y_data_1 and y_data_2 on the same x_data
        plt.plot(x_data, y_data_1, 'r', label='Varma Sidan')
        plt.plot(x_data, y_data_2, 'b', label='Kalla Sidan')

        # Set labels and title
        plt.title("Temperatur profil")
        plt.xlabel("Del av växlare")
